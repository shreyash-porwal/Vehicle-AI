...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'Vehicle-AI Motors',
    "address" TEXT NOT NULL DEFAULT 'GM Road, Ujjain, Madhya Pradesh',
    "phone" TEXT NOT NULL DEFAULT '+91 9516211500',
    "email" TEXT NOT NULL DEFAULT 'contact@vehicle-ai.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
