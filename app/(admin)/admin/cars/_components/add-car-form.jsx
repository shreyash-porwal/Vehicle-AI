...
const AddCarForm = () => {
  ...
  // Manual Form Related Logic Starts Here ==================================
    ...
    validFiles.forEach((file) => {
      ...
      reader.onload = (e) => {
        ...
        if (newImages.length === validFiles.length) {
          ...
          setImageError("");
          toast.success(
            `Successfully uploaded ${validFiles.length} ${
              validFiles.length > 1 ? "images" : "image"
            }`
          );
        }
      };
  ...
  // Manual Form Related Logic Ends Here ==============================
        ...
        <TabsContent value="manual" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter the details of car you want to add
              </CardDescription>
            </CardHeader>
            <CardContent>
